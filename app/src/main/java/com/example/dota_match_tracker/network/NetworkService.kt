...
interface MatchInfoTrackService {
    @GET("matches/{id}")
    suspend fun getMatchInfo(@Path("id") id: String): NetworkMatchData
...
/**
 * Main entry point for network access. Call like `Network.matches/{matchId}`
 */
object Network {
